...
"""Copy the X Search plugin to a local install path and render absolute MCP config."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Install the X Search plugin into a local Codex plugin directory."
    )
    parser.add_argument(
        "--plugin-root",
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional compatibility alias path to point at the installed plugin. "
